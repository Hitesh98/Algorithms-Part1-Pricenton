...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        final double num = (that.y - this.y)*1.0;
        final double den = (that.x - this.x)*1.0;
        if (num == 0) {
            if (den != 0) {
                return (+0.0);
            } else {
    ...
    public static void main(String[] args) {
        ...
        pointArray[1] = new Point(4, 1);
        pointArray[2] = new Point(3, 1);
        pointArray[3] = new Point(2, 1);
        pointArray[4] = new Point(2, 2);
        pointArray[5] = new Point(3, 3);
        pointArray[6] = new Point(4, 4);
